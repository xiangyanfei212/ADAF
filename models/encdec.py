...
# Originally Written by Ze Liu and Jingyun Liang, Modified by Yanfei Xiang.
# -----------------------------------------------------------------------------------
...
class EncDec(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 1, encoder
        self.conv_first = nn.Conv2d(params.in_chans, params.embed_dim, 3, 1, 1)
        ...
        self.upsample = Upsample(params.upscale, params.num_feat)
        self.conv_last = nn.Conv2d(params.num_feat, params.out_chans, 3, 1, 1)
